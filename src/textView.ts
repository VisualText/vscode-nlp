...
export class TextView {
	...
	constructor(ctx: vscode.ExtensionContext) {
		...
		ctx.subscriptions.push(this.textView);
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.refreshAll', () => treeDataProvider.refresh()));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.importFiles', (textItem) => treeDataProvider.importFiles(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.existingFolder', (textItem) => treeDataProvider.existingFolder(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.rename', (textItem) => treeDataProvider.rename(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.renameDir', (textItem) => treeDataProvider.renameDir(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.convert', (textItem) => treeDataProvider.convert(textItem)));

		ctx.subscriptions.push(vscode.commands.registerCommand('textView.openFile', (textItem) => this.openFile(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.analyzerCurrent', () => this.analyzerCurrent()));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.analyze', (textItem) => this.analyze(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.analyzeDir', (textItem) => this.analyzeDir(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.runRegressionItem', (textItem) => this.runRegressionItem(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.blessRegressionItem', (textItem) => this.blessRegressionItem(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.openText', () => this.openText()));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.search', () => this.search()));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.fastLoad', () => this.fastLoad(true)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.fastLoadOff', () => this.fastLoad(false)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.newTextTop', (textItem) => this.newText(textItem, true)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.newText', (textItem) => this.newText(textItem, false)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.newDirTop', (textItem) => this.newDir(textItem, true)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.newDir', (textItem) => this.newDir(textItem, false)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.deleteFile', (textItem, allItems) => this.deleteFile(textItem, allItems)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.deleteDir', (textItem, allItems) => this.deleteFile(textItem, allItems)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.deleteFileLogs', (textItem) => this.deleteFileLogs(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.deleteAnalyzerLogs', () => this.deleteAnalyzerLogs()));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.splitDir', (textItem) => this.splitDir(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.updateTitle', (textItem) => this.updateTitle(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.propertiesFile', (textItem) => this.propertiesFile(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.propertiesFolder', (textItem) => this.propertiesFolder(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.explore', (textItem) => this.explore(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.exploreAll', (textItem) => this.exploreAll(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.moveToFolder', (textItem) => this.moveToFolder(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.moveUp', (textItem) => this.moveUp(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.copyToAnalyzer', (textItem) => this.copyToAnalyzer(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.modAdd', (textItem) => this.modAdd(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.runTest', (textItem) => this.runTest(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.deleteTest', (textItem) => this.deleteTest(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.editTest', (textItem) => this.editTest(textItem)));
		ctx.subscriptions.push(vscode.commands.registerCommand('textView.python', (textItem) => this.python(textItem)));
