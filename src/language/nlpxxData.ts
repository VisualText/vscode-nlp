...
export const BUILTIN_FUNCTIONS: string[] = [
	"abs", "addarg", "addattr", "addcnode", "addconcept", "addconval", "addnode",
	"addnumval", "addstmt", "addstrs", "addstrval", "addsval", "addword",
	"arraylength", "attrchange", "attrexists", "attrname", "attrtype",
	"attrvals", "attrwithval", "batchstart", "cap", "cbuf", "ceiling", "closefile",
	...
	"findvals", "findwordpath", "firstnode", "floor", "flt", "fltval", "fncallstart",
	...
	"listnode", "LJ", "lj", "log", "logten", "lookup", "lowercase", "makeconcept",
	"makeparentconcept", "makephrase", "makestmt", "merge", "merger", "mkdir",
	"mod", "movecleft", "movecright", "movesem", "ndump", "next", "nextattr", "nextval",
	...
	"pnup", "pnvar", "pnvarnames", "pow", "pranchor", "prchild", "preaction",
	"printvar", "pndeletechilds", "pnrename", "prev", "print", "printr", "prlit",
	"prrange", "prtree", "prunephrases", "prxtree", "randomint", "regexp", "regexpi",
	...
	"rmnode", "rmphrase", "rmval", "rmvals", "rmword", "round", "sdump", "setbase",
	...
	"sqrt", "startout", "stem", "stopout", "str", "strchar", "strchr", "strchrcount",
	...
	"succeed", "suffix", "system", "take", "today", "topdir", "truncate", "unknown",
