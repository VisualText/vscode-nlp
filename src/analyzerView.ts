...
export class AnalyzerView {
	...
	constructor(ctx: vscode.ExtensionContext) {
		...
		ctx.subscriptions.push(this.analyzerView);
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.refreshAll', () => analyzerViewProvider.refresh()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.newAnalyzer', (resource) => this.newAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteAnalyzer', resource => this.deleteAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteFile', resource => this.deleteFile(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteFolder', resource => this.deleteFolder(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.loadExampleAnalyzers', _resource => this.loadExampleAnalyzers()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.openAnalyzer', resource => this.openAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteAnalyzerLogs', resource => this.deleteAnalyzerLogs(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteAllAnalyzerLogs', () => this.deleteAllAnalyzerLogs()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.updateTitle', resource => this.updateTitle(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.copyAnalyzer', resource => this.copyAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.dupeAnalyzer', resource => this.dupeAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.explore', resource => this.explore(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.newFolder', resource => this.newFolder(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.moveToFolder', resource => this.moveToFolder(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.moveUp', resource => this.moveUp(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.readMe', resource => this.readMe(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.createReadMe', resource => this.editReadMe(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.editReadMe', resource => this.editReadMe(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deleteReadMe', resource => this.deleteReadMe(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.moveDownFolder', resource => this.moveDownFolder(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.moveToParent', resource => this.moveToParent(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.renameAnalyzer', resource => this.renameAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.renameFile', resource => this.renameFile(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.renameFolder', resource => this.renameFolder(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.openFile', resource => this.openFile(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.importAnalyzers', resource => this.importAnalyzers(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.manifestGenerate', resource => this.manifestGenerate(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.newECLFile', resource => this.newECLFile(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.exploreAll', () => this.exploreAll()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.copyAll', () => this.copyAll()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.updateColorizer', () => this.updateColorizer()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.video', () => this.video()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.copyPath', () => this.copyPath()));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.compileAnalyzer', resource => this.compileAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.compileAnalyzerOnly', resource => this.compileAnalyzerOnly(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.deployCompiledAnalyzer', resource => this.deployCompiledAnalyzer(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.runRegressionTest', resource => this.runRegressionTest(resource)));
		ctx.subscriptions.push(vscode.commands.registerCommand('analyzerView.blessRegression', resource => this.blessRegression(resource)));
